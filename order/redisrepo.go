...
func (o *RedisRepo) Insert(ctx context.Context, order Order) error {
...
func (o *RedisRepo) FindByID(ctx context.Context, id uint64) (Order, error) {
	key := orderIDKey(id)
...
func (o *RedisRepo) Update(ctx context.Context, order Order) error {
	data, err := json.Marshal(order)
	if err != nil {
